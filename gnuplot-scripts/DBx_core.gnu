...
plot "../dat_DBx/core.dat" every 4::3::27 title "CUBIT" lc rgb "blue" lw 8 ps 1.5 pt 6 with linespoints,\
      ...
      "../dat_DBx/core.dat" every 4::1::25 title "Hash" lc rgb "sea-green" lw 8 ps 1.5 pt 10 dt 9 with linespoints,\
      "../dat_DBx/core.dat" every 4::0::24 title "Scan" lc rgb "black" lw 8 ps 1.5 pt 12 dt 5 with linespoints
