...
def cdf():
    ...
    cmd2 = "./build/nicolas -w 16 -a cubit -m mix --number-of-queries 950 -r 50 -c 100 -i 100M_100/ -n 100000000 -v yes --fence-pointer yes --fence-length 100000 > figure_cubit_latency_raw_w_16_ratio_0.05.dat"
    cmd3 = "./build/nicolas -w 16 -a cubit-lf -m mix --number-of-queries 950 -r 50 -c 100 -i 100M_100/ -n 100000000 -v yes --fence-pointer yes --fence-length 100000 > figure_cubit-lf_latency_raw_w_16_ratio_0.05.dat"
