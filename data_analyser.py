...
def latency_analysis(filename):
    ...
    for line in f:
        ...
        elif line.startswith('RABIT '):
            RABIT.append(float(a[-3]))
        else:
            continue
    if len(Hash) != 0:
    ...
    if len(ART) != 0:
        ...
        ret.append(0)
    if len(RABIT) != 0:
        ret.append(sum(RABIT) / len(RABIT)) 
    else:
        ret.append(0)
    return ret
...
def throughput_analysis(filename):
    ...
    for line in f:
        ...
        if line.startswith('ThroughputScan '):
            ...
            ret.append(float(a[-1]))
        elif line.startswith('ThroughputRABIT '):
            ret.append(float(a[-1]))
        else:
            continue
    return ret
...
def memory_analysis(filename):
    ...
    for line in f:
        ...
        if line.startswith('HashMemory '):
            ...
            ret.append(float(a[-1]))
        elif line.startswith('RabitMemory '):
            ret.append(float(a[-1]))
        else:
            continue
...
def index_time_analysis(filename):
    ...
    for line in f:
        ...
        if len(a) != 5:
            ...
            RABIT_tuple.append(float(a[-1]))
            RABIT_index.append(float(a[-2]))
        else:
            continue
    ...
    if len(RABIT_index) != 0:
        ret.append(sum(RABIT_index) / len(RABIT_index)) 
    else:
        ret.append(0)
    if len(RABIT_tuple) != 0:
        ret.append(sum(RABIT_tuple) / len(RABIT_tuple)) 
    else:
        ret.append(0)
